...
module.exports = {
  apps: [
    ...
    // ================================
    {
      ...
      args: 'automagik_spark.api.app:app --host ' + (envVars.AUTOMAGIK_SPARK_API_HOST || '0.0.0.0') + ' --port ' + (envVars.AUTOMAGIK_SPARK_API_PORT || '18883'),
      interpreter: 'none',
      ...
      env: {
        ...
        AUTOMAGIK_SPARK_API_PORT: envVars.AUTOMAGIK_SPARK_API_PORT || '18883',
        AUTOMAGIK_SPARK_API_CORS: envVars.AUTOMAGIK_SPARK_API_CORS || 'http://localhost:3000,http://localhost:18883',
        ...
        AUTOMAGIK_AGENTS_API_HOST: envVars.AUTOMAGIK_AGENTS_API_HOST,
        AUTOMAGIK_AGENTS_API_PORT: envVars.AUTOMAGIK_AGENTS_API_PORT,
        AUTOMAGIK_AGENTS_URL: envVars.AUTOMAGIK_AGENTS_URL,
